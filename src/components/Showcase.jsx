...
//     const isTablet = useMediaQuery({ query: '(max-width: 1024px)' });  // smaller than 1024px i.e. mobile or tablet
...
//                             </p>
//                             <p>
//                                 It drives Apple Intelligence on iPad Pro, so you can write, create, and accomplish more with ease.
...
//                                 And a next-gen GPU with hardware-accelerated ray tracing brings console-level graphics to your fingertips.
//                             </p>
